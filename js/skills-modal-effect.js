document.addEventListener('DOMContentLoaded', function() {
    const skills = [
        ...
        { name: 'responsive2', level: 75, description: 'Le Responsive Design est essentiel dans mes projets, assurant une expérience utilisateur optimale sur tous les appareils.', descriptionTrad: 'Responsive Design is essential in my projects, ensuring an optimal user experience on all devices.', color: '#cbc6d1' },
